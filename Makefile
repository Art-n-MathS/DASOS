...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Wed Jul 30 11:05:17 2014
# Project:  QtNGL.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/lib64/qt4/mkspecs/linux-g++ -o Makefile QtNGL.pro
#############################################################################
...
CXXFLAGS      = -pipe -msse -msse2 -msse3 -march=native -std=gnu++0x -std=c++0x -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector --param=ssp-buffer-size=4 -grecord-gcc-switches -m64 -mtune=generic -O2 -Wall -W -D_REENTRANT $(DEFINES)
...
Makefile: QtNGL.pro  /usr/lib64/qt4/mkspecs/linux-g++/qmake.conf /usr/lib64/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/lib64/qt4/mkspecs/linux-g++ -o Makefile QtNGL.pro
...
obj/main.o: src/main.cpp include/Manager.h \
		include/GLWindow.h \
		include/Camera.h \
		include/Texture.h
