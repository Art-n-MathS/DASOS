...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Apr 28 17:53:43 2014
# Project:  QtNGL.pro
# Template: app
# Command: /opt/QtSDK/Desktop/Qt/4.8.1/gcc/bin/qmake -spec /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/linux-g++ -o Makefile QtNGL.pro
#############################################################################
...
CXXFLAGS      = -pipe -msse -msse2 -msse3 -march=native -std=gnu++0x -std=c++0x -O2 -Wall -W -D_REENTRANT $(DEFINES)
...
Makefile: QtNGL.pro  /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/linux-g++/qmake.conf /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/linux-g++ -o Makefile QtNGL.pro
