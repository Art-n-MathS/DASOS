...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout_10->addWidget(m_lbObjectType, 0, 0, 1, 1);
        ...
        gridLayout_7->addWidget(m_cbHyperTexture, 6, 0, 1, 2);
        ...
        gridLayout_8->addWidget(tabWidget, 1, 4, 1, 1);
