...
#pragma pack(push)
#pragma pack(1)
   typedef struct Data_Point_Record_Format_0
    {
        int X;                                             //  4 bytes   0
        int Y;                                             //  4 bytes   1
        int Z;                                             //  4 bytes   2
        ...
        // ---------------------------------------------------------------
        char scan_angle_rank;                              //   1 byte   6
        // ---------------------------------------------------------------
        unsigned char file_marker;                         //   1 byte   7
        // ---------------------------------------------------------------
        unsigned short int user_bit_field;                 //   2 bytes  8
        // ---------------------------------------------------------------

    }Data_Point_Record_Format_0;
#pragma pack(pop)

    // point data format
#pragma pack(push)
#pragma pack(1)
   typedef struct Data_Point_Record_Format_1
    {
        int X;                                             //  4 bytes   0
        int Y;                                             //  4 bytes   1
        int Z;                                             //  4 bytes   2
        ...
        unsigned short int user_bit_field;                 //   2 bytes  8
        // ---------------------------------------------------------------
        double GPS_time;                                   //   8 bytes  9
    }Data_Point_Record_Format_1;
#pragma pack(pop)
...
#pragma pack(push)
#pragma pack(1)
   typedef struct Data_Point_Record_Format_3
    {
        int X;                                             //  4 bytes   0
        int Y;                                             //  4 bytes   1
        int Z;                                             //  4 bytes   2
        ...
        double GPS_time;                                   //   8 bytes  9
        // ---------------------------------------------------------------
        unsigned short int red;                            //   2 bytes 10
        // ---------------------------------------------------------------
        unsigned short int green;                          //   2 bytes 11
        // ---------------------------------------------------------------
        unsigned short int blue;                           //   2 bytes 12
        // ---------------------------------------------------------------
    }Data_Point_Record_Format_3;
#pragma pack(pop)
...
#pragma pack(push)
#pragma pack(1)
   typedef struct Data_Point_Record_Format_2
    {
        int X;                                             //  4 bytes   0
        int Y;                                             //  4 bytes   1
        int Z;                                             //  4 bytes   2
        ...
        unsigned short int user_bit_field;                 //   2 bytes  8
        // ---------------------------------------------------------------
        unsigned short int red;                            //   2 bytes  9
        // ---------------------------------------------------------------
        unsigned short int green;                          //   2 bytes 10
        // ---------------------------------------------------------------
        unsigned short int blue;                           //   2 bytes 11
        // ---------------------------------------------------------------
    }Data_Point_Record_Format_2;
#pragma pack(pop)
...
#pragma pack(1)
   typedef struct Data_Point_Record_Format_4             // 57 bytes
   {
      ...
      unsigned char user_data;                           //  1 bytes   7
      unsigned char gain;                                //  1 bytes   8
